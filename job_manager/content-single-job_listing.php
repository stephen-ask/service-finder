    ...
    <div class="banner-job-row">
      ...
      <div class="sf-banner-job-heading-wrap">
        <div class="sf-banner-job-heading-area">
          ...
          <div class="sf-banner-job-heading-large"><?php the_title(); ?></div>
          ...
          <aside  class="sf-jobdetail-sidebar">
            ...
            <div class="sf-jobdetail-blocks">
              <div class="sf-related-jobs">
                <div class="sf-related-job-pic"> <img src="images/related_jobs.jpg"> </div>
                <div class="sf-related-job-location"> <i class="feather-map-pin"></i> Jaipur</div>
                <div class="sf-related-job-name"> InwaveThemes <span class="feather-check"></span> </div>
                <div class="sf-related-job-rating"> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star text-gray"></span> <span class="sf-rating-lable"> 5 Ratings </span> </div>
              </div>
            </div>
            <?php if(get_post_meta($post->ID,'_job_location',true) != ''){ ?>	
            <div class="sf-jobdetail-blocks">
